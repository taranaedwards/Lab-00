...
```{r setup-tibble}
team_data <- tibble(
  name = c("Mayuko", "Alba", "Sophia", 
           "Arshpreet", "Ada"),
  github_username = c("Mayuco168", "alba2827", "sophiacauter", 
                      "arshpreet singh-04", "un4"), 
  colour = c("navy", "springgreen2", "steelblue1", 
             "blue", "colour 4"),
  hobby = c("napping", "h", "hobby 2", 
            "hobby 3", "hobby 4"),
